...
Use this reference when creating or revising a Four Foxes character, sibling variant, ally, outsider, or character leaflet.

## Core principle

Optimize for **flavour, clarity, and playable gaps**, not roster balance.

## Start from archetypes, then make the person
...
## Strong characters need strong gaps
...
## Keep the core situations in mind
...
## Personal Particulars must stay concrete
...
## Use the current sheet language
...
## Allowed character relationships
...
## Workflow for character creation or revision

1. Pick 2 or 3 archetypes or stereotypes to combine.
2. Decide how the character relates to the Foxes, if at all.
3. Choose a name and nickname with silent-cinema flavour.
...
9. If the task includes Typst implementation, continue with the layout and QA workflow.
...
6. If the sheet should include art, generate a portrait prompt optimized for the small horizontal cover slot.
7. Compile the new sheet.
8. Preview the PDF and check density, overflow, and readability.

## Final checks for character work

Before finishing, confirm:
- the character presents a vivid archetype
- the Personal Particulars are concrete and table-usable
- the sheet shows both leverage and limits
- the language is playable rather than generic
- the result still feels like it belongs in The Four Foxes
