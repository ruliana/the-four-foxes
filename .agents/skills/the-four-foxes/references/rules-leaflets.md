...
- case-specific People / Places / Objects / Events lists belong in a **case leaflet**, not a general rules leaflet

## Prefer procedure over encyclopedic lists

These trifolds are compact.
Long generic inspiration tables often read worse than a short procedure.

Prefer:
- concise rules text
- short examples
- small diagrams
- compact, table-usable procedure

Avoid filling a general-purpose rules trifold with long node catalogs unless the user specifically wants that.

## Current plot-graph procedure
...
## Workflow for editing rules/reference trifolds
...
## Final checks for rules leaflets

Before finishing, confirm:
- the leaflet stays self-contained
- the GM / plot content split is still correct
- long generic lists were removed unless truly needed
- the procedure is still easy to scan quickly
- footer labels match the actual panel contents
- any graph example remains readable at print size
