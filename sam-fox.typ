...
#align(center)[
  ...
  #text(size: 28pt, weight: "bold", font: "Linux Libertine", fill: accent)[Sam Fox]
  #v(0.2em)
...
While the others charge ahead or talk their way through, Sam reads the room ---
the scuff marks, the ash on the floor, the tilt of a man's chin. Most of the
time sober enough to see what others miss. Most of the time.
...
#can[*When drunk:* Jump, climb and escape any pursuer. When sober --- same, but usually ends up badly injured.]

// ── Limitations ─────────────────────────────────────────────────────────────

#section-header("Can't")

#cant[The detective abilities *require sobriety*. The combat edge *requires being drunk* (or armed with whatever's at hand).]
...
#v(0.3em)
#align(center)[
  #text(size: 7pt, fill: rgb("#101030"), tracking: 2pt)[
